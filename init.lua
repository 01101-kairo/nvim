...
for _, mapping in ipairs({
  ...
  { '<F7>',  [[:set foldmethod=indent<CR>]] },                        -- dobra bloco de codigo
  -- Navigate
...
set.smarttab = true             -- Tab
set.incsearch = true            -- isso aqui é pra 'pesquisa' ele completa palavras

set.termencoding = "utf8"       -- Yeah!! UTF-8 em tudo!
set.colorcolumn = "80"          -- essa linha horizontal ao lado
set.tw = 79                     -- quebra de linha aparti do 79° caracter
set.updatetime = 300            -- mensagem de erro

set.laststatus = 3              -- global statusline
set.showmode = false            -- sempre mostra em que modo estamos editando no momento
